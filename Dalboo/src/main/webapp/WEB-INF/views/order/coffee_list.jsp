...
<body>
	<div class="wrap">
		...
		<div id="content">
		  ...
		  <script>
			...
			<div class="outer">
				<ul id="tab-btn">
					<li><a href="newmenu_list.cf">신메뉴</a></li> <b>|</b>
					<li><a href="coffee_list.cf"><b>커피</b></a></li> <b>|</b>
				...
				<div id="menu-area">
						...
						<c:url var="coffee_delete" value="coffee_delete.cf">
	...
	function deleteMenu(bt){
		...
		if(confirm('삭제하시겠습니까?')){
			location.href='coffee_delete.cf?mNum=' + mNum;
		}else{
			return false;
		}
	}
