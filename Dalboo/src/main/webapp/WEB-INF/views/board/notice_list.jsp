	...
	<!-- 여기까지 -->
		      ...
		      <tr class="contentTR">
		         ...
		         <td align="left">
		            <c:if test="${ !empty loginUser }">
		               <c:url var="bdetail" value="notice_detail.bo">
		   ...
		   <!-- 페이징 처리 -->
		      <div id="buttonTab">
		            ...
		            <c:if test="${ pi.currentPage > 1 }"  >
		               <c:url var="before" value="event_list.bo">
		            ...
		            <c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
		               ...
		               <c:if test="${ p ne pi.currentPage }">
		                  <c:url var="pagination" value="event_list.bo">
		            ...
		            <c:if test="${ pi.currentPage < pi.maxPage }">
		               <c:url var="after" value="event_list.bo">
		                  <c:param name="page" value="${ pi.currentPage + 1 }"/>
		               </c:url> 
			 ...
			 <div id="buttonTab">
		            <c:if test="${ loginUser.rank_code eq '2'}">
		               &nbsp; &nbsp; &nbsp;
		               <button onclick="location.href='notice_insertView.bo';" id="insertbt">작성하기</button>
		            </c:if>
         	</div>
